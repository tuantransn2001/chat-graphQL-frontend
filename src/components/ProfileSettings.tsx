...
import {
  isProfileSettingsModalOpenSelector,
...
function ProfileSettings() {
  ...
  const profileImage = useUserStore(avatarUrlSelector);
  const updateProfileImage = useUserStore(updateProfileImageSelector);
  const fullname = useUserStore(fullnameSelector);
  const updateUsername = useUserStore(updateUsernameSelector);
